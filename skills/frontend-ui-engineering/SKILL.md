...
During frontend UI engineering, reference these Skill Extras when applicable:

- **UI/UX Design**: `@skills/ui-ux-design-pro/SKILL.md` (Design professional UI/UX with design systems, tokens, palettes, and high-fidelity prototyping)
- **Visual Consistency**: `@skills/design-taste-frontend/SKILL.md` (Validate visual consistency, spacing, typography, and design quality using metric-based rules)
